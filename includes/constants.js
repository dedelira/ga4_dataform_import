...
const SOURCE_PROJECT = "psicoterapia-e-afins" /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
const SOURCE_DATASET = "analytics_250911962"; /* the database containing the GA4 BigQuery exports */
const REPORTING_TIME_ZONE = "America/Sao_Paulo"; /* replace with your property reporting time zone, this will update the timestamp columns from UTC to your GA4 property timezone (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) */
const SEEDS_DATASET = "analytics_250911962"; /* the database containing the GA4 BigQuery data mapping seeds such as source categories */
...
// Define START_DATE here
const START_DATE = "2024-01-01"; // Set the start date in YYYY-MM-DD format
